...
public class AiGenerationServiceImpl implements AiGenerationService {
                ...
                .doOnComplete(()->{
                    Schedulers.boundedElastic().schedule(
                            ()->{
                                ...
                                finalizeChat(message,chatSession,fullResponseBuffer.toString(),duration);
                            }
                    );
    ...
    private void finalizeChat(String userMessage, ChatSession chatSession,String fullText,long duration){
